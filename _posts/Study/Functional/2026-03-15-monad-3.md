...
여담으로, 위의 내용은 그리 자명하진 않다. 따라서 논리적 비약이 어느 정도 섞여 있다. 그러나 관련된 모든 이론적 내용을 기술하기엔 글이 너무 길어질 것이고 또한 더 이상 프로그래밍이 아니라 수학적으로 접근해야 하는 내용이라 [별도의 포스팅](https://cloudholic.github.io/posts/monad-4/)에서 자세하게 다룬다.
