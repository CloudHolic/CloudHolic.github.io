...
$$\lambda_{\lbrace u, v \rbrace} \left(\dfrac{1}{2} \delta_{\lbrace u \rbrace} + \dfrac{1}{2} \delta_{\lbrace v \rbrace}) = \left\lbrace \dfrac{1}{2}\delta_u + \dfrac{1}{2}\delta_v \right\rbrace$$
