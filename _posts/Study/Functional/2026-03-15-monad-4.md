...
- $f: a, b \rightarrow u / c, d \rightarrow v$ ($\lbrace a, b \rbrace \mid \lbrace c, d \rbrace$ 분할)
- $g: a, c \rightarrow u / b, d \rightarrow v$ ($\lbrace a, c \rbrace \mid \lbrace b, d \rbrace$ 분할)
- $h: a, d \rightarrow u / b, c \rightarrow v$ ($\lbrace a, d \rbrace \mid \lbrace b, c \rbrace$ 분할)
...
즉, 임의의 두 모나드 쌍에 대해서 일반화시킬 방법이 필요하다. 이는 2020년에 이르러서야 Zwart & Marsden에 의해 성공했으며, 그 증명은 그들의 논문 [No-Go Theorems for Distributive Laws](https://arxiv.org/abs/2003.12531)에 정리되어 있다.
