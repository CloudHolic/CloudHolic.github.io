...
![Back Propagation](/assets/img/class/spring2026/la_back_propagation2.png)
...
![Back Propagation2](/assets/img/class/spring2026/la_back_propagation3.png)
...
![f(x) ReLU](/assets/img/class/spring2026/la_locally_1.png)
...
![sin(x) Prior](/assets/img/class/spring2026/la_locally_2.png)
...
![f(x) SIREN](/assets/img/class/spring2026/la_locally_3.png)
...
![Convolutional Layer](/assets/img/class/spring2026/la_conv_layer.png)
...
![Convolutional Layer Sliding](/assets/img/class/spring2026/la_conv_layer2.png)

이러한 식으로 필터가 데이터 전체를 스캔하면, 아래와 같은 출력이 나오게 된다.

![Convolution Filter](/assets/img/class/spring2026/la_conv_filter.png)
...
![Multichannel Convolution Layer](/assets/img/class/spring2026/la_multichannel_conv.png)
...
![Pooling](/assets/img/class/spring2026/la_pooling.png)
...
![CNN Classification](/assets/img/class/spring2026/la_cnn_classification.png)

이미지의 Classification 문제를 풀 때는 위와 같이 Convolution Block을 여러 번 반복하여 1D까지 내리게 된다.

![CNN Encoder-Decoder](/assets/img/class/spring2026/la_cnn_encoder_decoder.png)

만일 이미지를 생성하고 싶다면, 먼저 Encoder를 통해 우리가 원하는 답 $z$를 찾을 때까지 줄인 후, 거기서부터 Decoder를 통해 다시 늘리는 방식을 취한다.

![ResNet](/assets/img/class/spring2026/la_cnn_resnet.png)
...
![U-Net](/assets/img/class/spring2026/la_cnn_unet.png)
