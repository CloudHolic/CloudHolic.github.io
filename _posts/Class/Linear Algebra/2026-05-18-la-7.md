---
title: "Linear Algebra 7 - Normalizing Flow"
...
$$p_X(x)=p_Z(f^{-1}(x))\left\vert\det\left(\dfrac{\partial f^{-1}(x)}{\partial x}\right)\right\vert$$
...
![Motivation](/assets/img/class/spring2026/la_flow_motivation.png)
