...
![Seq2Seq](/assets/img/class/spring2026/dl_seq2seq_translator.png)
...
![Seq2Seq 2](/assets/img/class/spring2026/dl_seq2seq_translator2.png)
...
![Image Attention](/assets/img/class/spring2026/dl_attention_image.png)

사진을 보게 된다면 먼저 가운데부터 보고, 그 다음부터 주요 요소들로 눈동자가 빠르게 움직인다. 순간순간 집중하는 대상이 달라지며, 놀랍게도 "주요 요소"가 아닌 대상들로는 시선이 거의 가지 않는다. 

![Sentence Attention](/assets/img/class/spring2026/dl_attention_sentence.png)
...
![Attention 1](/assets/img/class/spring2026/dl_seq2seq_attention.png)

즉, 위의 그림과 같이 일종의 Shortcut이 형성되어서, 각각의 상황마다 모델이 필요한 정보를 더 찾아올 수 있게 해주는 것이다.

![Attention 2](/assets/img/class/spring2026/dl_seq2seq_attention2.png)
...
![Machine Translation](/assets/img/class/spring2026/dl_seq2seq_translation.png)
...
![Voice Recognition](/assets/img/class/spring2026/dl_seq2seq_recognition.png)

이번에는 음성 인식 상황이다. Input Sequence가 음성이라 뒤에서부터 보는 접근이 불가능하여 위의 기계번역과는 다르게 일반적인 단방향 RNN으로 되어 있다. 그 점 외에는 위의 기계 번역 문제와 동일한 원리이다.

![Image Captioning](/assets/img/class/spring2026/dl_seq2seq_captioning.png)
...
![Attention Detail](/assets/img/class/spring2026/dl_seq2seq_attention_detail.png)
...
1. Self Attention vs Cross Attention
   ...
   ![Self Attention](/assets/img/class/spring2026/dl_self_attention.png)
...
![Neural Image Caption Generation](/assets/img/class/spring2026/dl_neural_image_caption_generation.png)

![Neural Image Caption Generation2](/assets/img/class/spring2026/dl_neural_image_caption_generation2.png)
...
![Soft vs Hard](/assets/img/class/spring2026/dl_attention_soft_hard.png)
...
![Visual Question & Answering](/assets/img/class/spring2026/dl_visual_question.png)
...
![Neural Turing Machine](/assets/img/class/spring2026/dl_ntm.png)
...
![Reading/Writing](/assets/img/class/spring2026/dl_ntm_rw.png)
...
![Reading](/assets/img/class/spring2026/dl_ntm_read.png)
...
![Writing](/assets/img/class/spring2026/dl_ntm_write.png)
...
![Addressing Diagram](/assets/img/class/spring2026/dl_ntm_addressing_diagram.png)
...
![Addressing](/assets/img/class/spring2026/dl_ntm_addressing.png)
...
![Transformer Attention](/assets/img/class/spring2026/dl_transformer_attention.png)
...
![Transformer Self vs Cross Attention](/assets/img/class/spring2026/dl_transformer_attention_self_cross.png)
...
![Transformer Structure](/assets/img/class/spring2026/dl_transformer_structure.png)
...
![Transformer Encoder](/assets/img/class/spring2026/dl_transformer_encoder.png)
...
![Transformer Decoder](/assets/img/class/spring2026/dl_transformer_decoder.png)
...
![BERT](/assets/img/class/spring2026/dl_bert.png)
...
![Image GPT](/assets/img/class/spring2026/dl_image_gpt.png)
...
![ViT](/assets/img/class/spring2026/dl_vision_transformer.png)
