...
이제 Input Sequence를 $x=[x_1,x_2,\ldots,x_n]$, $y=[y_1,y_2,\ldots,y_m]$이라고 하자. Bidirectional RNN을 쓰고 있는 상황이기 때문에, Encoder의 Hidden State $h_i=[\vec{h_i}^T;\overleftarrow{h_i}^{T}]^T, i=1,2,\ldots,n$이 된다.
