---
title: "Deep Learning 2 - FNNs & DNNs"
...
![Neuron](/assets/img/class/spring2026/dl_neuron.png)
...
![Perceptron](/assets/img/class/spring2026/dl_perceptron.png)
...
![Perceptron Algorithm](/assets/img/class/spring2026/dl_perceptron_algorithm.png)
...
![Neural Network](/assets/img/class/spring2026/dl_neural_network.png)
...
![FNN](/assets/img/class/spring2026/dl_fnn.png)
...
![Gradient Descent](/assets/img/class/spring2026/dl_gradient.png)
...
![Back Propagation](/assets/img/class/spring2026/dl_back_prop.png)
...
![Compuatational Graph](/assets/img/class/spring2026/dl_computational_graph.png)
...
![Autoencoder](/assets/img/class/spring2026/dl_autoencoder.png)
...
![Activation Functions](/assets/img/class/spring2026/dl_activation.png)
...
![Denoising](/assets/img/class/spring2026/dl_denoising.png)
...
![Dropout](/assets/img/class/spring2026/dl_dropout.png)
...
![Dropconnect](/assets/img/class/spring2026/dl_dropconnect.png)
...
![NAG](/assets/img/class/spring2026/dl_nag.png)
...
여기서 $\text{RMS}$는 Root Mean Squared로, $\text{RMS}[x]=\sqrt{\mathbb{E}[x]+\epsilon}$을 의미한다. 결국 Adadelta에는 그동안 잘 설정했던 Learning rate $\eta$가 아예 필요없는 구조가 되었다.
...
여기서 $m_t$가 Momentum에 해당하고, $v_t$가 RMSprop에 해당한다. 위의 두 값 모두 0으로 초기화되기 때문에, 특히 학습 초기에, 그리고 $\beta_1$과 $\beta_2$가 1에 가까울수록 0으로 편향하는 성질을 지닌다.
...
이제야 비로소 모든 파라미터가 동일한 비율로 Weight decay를 겪게 된다. 그리고 앞에서도 언급했듯, 현재는 이 AdamW가 사실상 표준의 위치가 되어 특별한 사유가 없는 한 AdamW를 주로 쓰게 될 것이다. 사실 위에서 언급된 최적화 방법들 중 Momentum부터 Adam까지의 내용을 총망라한게 AdamW이기도 하다.
