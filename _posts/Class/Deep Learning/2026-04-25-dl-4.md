---
title: "Deep Learning 4 - RNNs"
date: 2026-04-25 23:34:00 +0900
categories: ["Class", "Deep Learning"]
tags: ["Class", "Machine Learning", "Deep Learning", "Recurrent", "RNNs"]
math: true
---
...
![RNN Structure](/assets/img/class/spring2026/dl_rnn_structure.png)
...
![Process Sequences](/assets/img/class/spring2026/dl_process_sequences.png)
...
![RNN Mathematics](/assets/img/class/spring2026/dl_rnn_math.png)
...
![Bi-directional RNN](/assets/img/class/spring2026/dl_rnn_bidirectional.png)
...
![RNN Graph 1](/assets/img/class/spring2026/dl_rnn_graph1.png)

출력 $y_i$를 배제한 일반적인 Computational Graph의 형태는 위와 같다. 역시 $W$는 모든 단계에서 공유된다.


![RNN Graph 2](/assets/img/class/spring2026/dl_rnn_graph2.png)
...
![RNN Graph 3](/assets/img/class/spring2026/dl_rnn_graph3.png)

![RNN Graph 4](/assets/img/class/spring2026/dl_rnn_graph4.png)
...
![RNN Training](/assets/img/class/spring2026/dl_rnn_training.png)
...
![BPTT](/assets/img/class/spring2026/dl_rnn_backpropagation.png)

모든 단계별로 전부 이 Loss에 대한 어느 정도의 책임이 존재한다. 따라서 위와 같이 그 모든 단계에 대해서 Backpropagation을 수행해야 한다. 그런데 이 과정은 상당히 오래 걸린다.

![Truncated BPTT](/assets/img/class/spring2026/dl_truncated_bptt.png)
...
![Sonnet](/assets/img/class/spring2026/dl_rnn_sonnet.png)
...
![Tagging](/assets/img/class/spring2026/dl_rnn_tagging.png)
...
![Sentiment Classification 1](/assets/img/class/spring2026/dl_rnn_sentiment1.png)

![Sentiment Classification 2](/assets/img/class/spring2026/dl_rnn_sentiment2.png)
...
![Speech Recognition](/assets/img/class/spring2026/dl_rnn_recognition.png)
...
![Question Answering](/assets/img/class/spring2026/dl_rnn_answering.png)
...
![Captioning 1](/assets/img/class/spring2026/dl_rnn_captioning_cnn.png)
...
![Captioning 2](/assets/img/class/spring2026/dl_rnn_captioning_vgg.png)
...
![Interpretable Cell 1](/assets/img/class/spring2026/dl_rnn_interpretable1.png)

![Interpretable Cell 2](/assets/img/class/spring2026/dl_rnn_interpretable2.png)

![Interpretable Cell 3](/assets/img/class/spring2026/dl_rnn_interpretable3.png)

![Interpretable Cell 4](/assets/img/class/spring2026/dl_rnn_interpretable4.png)

![Interpretable Cell 5](/assets/img/class/spring2026/dl_rnn_interpretable5.png)

![Interpretable Cell 6](/assets/img/class/spring2026/dl_rnn_interpretable6.png)
...
![DNN Structure](/assets/img/class/spring2026/dl_dnn_structure.png)
...
![CNN Structure](/assets/img/class/spring2026/dl_cnn_structure.png)
