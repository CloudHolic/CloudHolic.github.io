...
$$\dfrac{\partial}{\partial \theta}\log P(D;\theta)=\dfrac{n_H}{\theta}-\dfrac{n_T}{1-\theta}=0$$

$$\therefore \hat{\theta}=\dfrac{n_H}{n_H+n_T}$$
...
![Linear Regression](/assets/img/class/spring2026/aml_linear_regression.png)
