...
![Convolutional Filter](/assets/img/class/aml_convolutional_filter.png)
...
![Feature Map](/assets/img/class/aml_feature_map.png)
...
![Pooling](/assets/img/class/aml_pooling.png)
...
![Next word Prediction](/assets/img/class/aml_sequence_modeling.png)
...
![Fixed Window](/assets/img/class/aml_fixed_window.png)
...
![Bag of words](/assets/img/class/aml_bag_of_words.png)
...
![Big Fixed Window](/assets/img/class/aml_big_fixed_window.png)
...
CNN에서 이 문제를 해결하기 위해 고안한 구조를 생각해보면, 결국 Parameter가 이러한 순서 정보를 잘 반영하도록 공유하는 형태가 되어야 한다는 것이 초창기의 아이디어였다.
...
![RNN](/assets/img/class/aml_rnn.png)
