...
![Discriminative Model 1](/assets/img/class/spring2026/aml_discriminative_model_1.png)

위와 같이 Label이 개와 고양이만 존재하는 데이터셋이라면, 이 모델의 Output은 "개일 확률", "고양이일 확률"의 2가지로만 나온다. 

![Discriminative Model 2](/assets/img/class/spring2026/aml_discriminative_model_2.png)
...
![Generative Model](/assets/img/class/spring2026/aml_generative_model.png)
...
![Histogram](/assets/img/class/spring2026/aml_histogram.png)
...
![Diffusion](/assets/img/class/spring2026/aml_diffusion.png)
...
![Noising Process](/assets/img/class/spring2026/aml_diffusion_noising.png)
...
![Denoising Process](/assets/img/class/spring2026/aml_diffusion_denoising.png)
...
![DDPM](/assets/img/class/spring2026/aml_ddpm.png)
...
![DDPM Algorithm](/assets/img/class/spring2026/aml_ddpm_algorithm.png)

또한 DDPM은 Noise가 추가/제거되기만 하고 Dimension이 변화되지 않기 때문에 아래와 같이 U-Net 구조를 쓰기 좋다.

![DDPM Structure](/assets/img/class/spring2026/aml_ddpm_structure.png)
